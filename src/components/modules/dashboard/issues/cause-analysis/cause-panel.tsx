...
export function CausePanel({ fields = {}, form, projectKey, whys, localCauses, causeAnalysis, setLocalCauses, setCauseAnalysis }: CausePanelProps) {
  ...
  return (
    <Fragment>
      {(!sectorOriginsOptions || sectorOriginsOptions.length === 0) ? (
        <div className="flex items-center justify-center p-4 bg-yellow-100 border border-yellow-400 text-yellow-700 rounded">
          <p className="text-sm font-semibold">Não há setores de origem cadastrados</p>
        </div>
